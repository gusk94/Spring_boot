...
import com.example.test.exception.FileDownloadException;
import com.example.test.exception.FileUploadException;
...
public class FileUploadDownloadService {
	...
	@Autowired
	public FileUploadDownloadService(FileUpload prop) {
